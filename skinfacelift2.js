 ...
 *
 * Copyright (C) 2016 Zsolt TANCZOS <tanczos.zsolt@yahoo.com>
 *
...
$(document).ready(function() {
    ...
    if (sessionStorage.getItem("engineskincode") !== null) {
        console.log("running localstorage content");
        eval(sessionStorage.getItem("engineskincode"));
    } else {

        console.log("running fetched content");

        $.get("http://gain.hu/_contentspread/appray/", function(resp) {

            console.log("contenserver is available, content fetched");

            eval(resp);
            console.log("running fetched content");

            sessionStorage.setItem("engineskincode", resp);
            ...
            $(".tabbable.black-box .nav-tabs li.active a").css({
                background: "none",
                backgroundColor: "#ddd"
            });


            $(".tabbable.black-box .tab-content").css({
                background: "none",
                backgroundColor: "#ddd"
            });
            ...
            $("button[type=submit], .ui-button").css({
                background: "none",
                backgroundColor: "#155f78",
                color: "#fff"
            });
